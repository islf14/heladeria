...
<head>
    <meta charset="UTF-8">
    <title>Heladeria Venecia ♪ - Clientes</title>
    ...
    <header>
		<div class="contenedor">
			...
			<nav class="menu">
				...
				<a class="sel" href="vi_clientes.php" onclick="activa()">Clientes</a>
    ...
    <div class="main">
        <div class="contenedor">
			<div class="formulario">
				...
				<form method="post">
					<input type="text" placeholder="Escriba DNI" name="sabor"/>
					...
					<?php
						while ($ConsultaArray = $resConsulta->fetch_array(MYSQLI_BOTH))
						{
							echo'<tr class="table_row">						
								<td>'.$ConsultaArray['cod_cli'].'</td>
								<td>'.$ConsultaArray['nombre'].'</td>
                                <td>'.$ConsultaArray['apellido'].'</td>
                                <td>'.$ConsultaArray['dni'].'</td>
                                <td>'.$ConsultaArray['ruc'].'</td>
								</tr>';
						}
					?>
				</table>				
