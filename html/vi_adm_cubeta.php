...
<?php
	...
	$consulta="SELECT i.cod_ing_cubeta, concat(e.nombre,' ',e.apellido) as nombres,c.sabor, i.fecha,i.cantidad_ingreso,i.cantidad_salida
    FROM ingreso_cubeta i INNER JOIN inventario_cubeta c
    ON i.inventario_cod_inv=c.cod_inv INNER JOIN empleado e
...
<head>
    <meta charset="UTF-8">
    <title>Heladeria Venecia ♪ - Adm cubeta</title>
    ...
    <header>
		<div class="contenedor">
			...
			<nav class="menu">
				...
				<a class="sel" href="vi_adm_cubeta.php" onclick="activa()">Adm. Cubeta</a>
    ...
    <div class="main">
        <div class="contenedor">
			<div class="formulario">
				<h3 class="titulo">Administración de cubetas</h3>
				<form method="post">
