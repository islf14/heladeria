...
<?php
	...
	if (isset($_POST['buscar']))
	{
		$sabor=$_POST['sabor'];
		if($sabor!="")
		$where="where nombre_carta like '%".$sabor."%'";		
	}
	/////////////////////// CONSULTA A LA BASE DE DATOS /////////////////////////
	$consulta="SELECT * FROM carta $where ";
    ...
    <header>
		<div class="contenedor">
			...
			<nav class="menu">
				...
				<a class="sel" href="vi_carta.php" onclick="activa()">Carta</a>
    ...
    <div class="main">
        <div class="contenedor">
			<div class="formulario">
				...
				<form method="post">
					<input type="text" placeholder="Nombre de carta" name="sabor"/>
					...
					<?php
						while ($ConsultaArray = $resConsulta->fetch_array(MYSQLI_BOTH))
						{
							echo'<tr class="table_row">						
								<td>'.$ConsultaArray['cod_carta'].'</td>
								<td>'.$ConsultaArray['nombre_carta'].'</td>
                                <td>'.$ConsultaArray['precio'].'</td>
